          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="text-ellipsis">
                ...
                <td><span class="text-ellipsis">
                    <?php
                        if($pro->product_tinhtrang==0){
                    ?>
                        <a href="{{URL::to('/unactive-tinhtrang/'.$pro->product_id)}}"><span>Hết hàng</span></a>
                        <?php
                        }else{

                        ?>
                            <a href="{{URL::to('/active-tinhtrang/'.$pro->product_id)}}"><span>Còn hàng</span></a>
                        <?php
                        }
                     ?>
                    </span></td>
